    ...
    return (
        <div className="fixed z-[90] w-full h-dvh backdrop-brightness-[.3] backdrop-saturate-[0] left-0 top-0 grid place-items-center bg-[--dColor]" style={{"--dColor":dColor+'cc'}}>
            <a onClick={() =>setModal(false)} style={{"--dColor":dColor}}
                ...
                <ImageZoom fullWidth={true} height="100%" src={openedImage} className='[&_img]:w-auto [&_img]:h-[95dvh] [&_img]:block [&_img]:mx-auto [&_img]:rounded-3xl [&_img]:object-contain !bg-transparent' zoom="100" alt={openedImage}/>
        </div>
    )
}