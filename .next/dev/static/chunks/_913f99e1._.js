...
"[project]/components/DeleteIcon.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/EditIcon.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/ReplaceIcon.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/Figure.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$DeleteIcon$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/DeleteIcon.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$EditIcon$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/EditIcon.jsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ReplaceIcon$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ReplaceIcon.jsx [app-client] (ecmascript)");
...
function Figure({ url, cat, index, name, colors, setDcolor, setUpWindow, setNova, id, array, width, height }) {
    ...
    const handleRename = async (newName)=>{
        ...
        const { data: fileData, error: downloadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("ilustras").download(filePath);
        if (downloadError) {
            console.error("Erro ao baixar o arquivo:", downloadError);
            return;
        }
        const { data: uploadData, error: uploadError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("ilustras").upload(newFilePath, fileData);
        if (uploadError) {
        ...
        const { error: deleteError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("ilustras").remove([
            filePath
        ]);
        if (deleteError) {
    ...
    const handleDelete = async (url)=>{
        const filePath = url.split('/ilustras/')[1];
        const { error: storageError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from("ilustras").remove([
            filePath
        ]);
        if (storageError) {
        ...
        const { error: dbError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("imagens").delete().eq("url", url);
        if (dbError) {
...
"[project]/components/mansonry.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Figure$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/Figure.jsx [app-client] (ecmascript)");
...
const Mansonry = ({ category, initialImages = [] })=>{
    _s();
    const { setUpWindow, setNova } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AppContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppContext"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            imagePalettes.map(({ url, colors, name, id, width, height }, index, array)=>{
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Figure$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    array: array,
                    url: url,
                    cat: category,
                    index: index,
...
//# sourceMappingURL=_913f99e1._.js.map