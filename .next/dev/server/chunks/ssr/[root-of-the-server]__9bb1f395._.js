...
async function getAllImages() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("imagens").select("id, nome, categoria, created_at").order('created_at', {
        ascending: false
    });
    if (error) {
