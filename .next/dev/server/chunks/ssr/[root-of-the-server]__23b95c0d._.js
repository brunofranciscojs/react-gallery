...
const AuthProvider = ({ children })=>{
    ...
    const login = async (usuario, password)=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('settings').select('usuario, password').eq('usuario', usuario).single();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__23b95c0d._.js.map